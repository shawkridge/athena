...
class MemoryMigrationManager:
    ...
    def migrate_project_memories(
        ...
        if include_graph:
            counts["entities"] = self._migrate_graph_entities(source_project_id, target_project_id)
        ...
        if include_episodic:
            counts["episodic"] = self._migrate_episodic_events(source_project_id, target_project_id)

        if include_procedural:
            counts["procedural"] = self._migrate_procedures(source_project_id, target_project_id)

        if include_prospective:
            counts["prospective"] = self._migrate_tasks(source_project_id, target_project_id)
    ...
    def _migrate_semantic_memories(self, source_project_id: int, target_project_id: int) -> int:
    ...
    def _migrate_episodic_events(self, source_project_id: int, target_project_id: int) -> int:
    ...
    def _migrate_procedures(self, source_project_id: int, target_project_id: int) -> int:
    ...
    def _migrate_tasks(self, source_project_id: int, target_project_id: int) -> int:
    ...
    def _migrate_graph_entities(self, source_project_id: int, target_project_id: int) -> int:
    ...
    def _migrate_graph_relations(self, source_project_id: int, target_project_id: int) -> int:
    ...
    def _migrate_associations(self, source_project_id: int, target_project_id: int) -> int:
    ...
    def get_migration_stats(self, source_project_id: int) -> Dict[str, int]:
