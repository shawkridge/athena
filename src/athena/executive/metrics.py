...
class ExecutiveMetrics:
    ...
    def calculate_metrics(self, project_id: int, date_range: Optional[tuple] = None) -> MetricsSnapshot:
        """
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            switch_metrics = self._calculate_switch_overhead(project_id, cursor)

            # Get completion time distribution
            completion_times = self._get_completion_times(project_id, cursor)
