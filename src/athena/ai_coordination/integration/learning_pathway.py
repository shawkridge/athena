...
class LearningPathway:
    ...
    def create_execution_pathway(
        self, session_id: str, source_id: str, episodic_event_id: int, confidence: float = 0.8
    ) -> int:
    ...
    def link_to_semantic(self, pathway_id: int, semantic_id: int) -> bool:
    ...
    def link_to_procedural(self, pathway_id: int, procedural_id: int) -> bool:
    ...
    def record_pathway_metric(self, pathway_id: int, metric_name: str, metric_value: float) -> int:
    ...
    def get_learning_effectiveness(self, session_id: str) -> dict:
        ...
        consolidation_rate = (
            (consolidated_count / total_pathways * 100) if total_pathways > 0 else 0
        )
