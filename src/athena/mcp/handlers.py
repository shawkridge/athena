...
# Phase 1-5 Handler Refactoring: Domain-Extracted Modules
...
class MemoryMCPServer(EpisodicHandlersMixin, MemoryCoreHandlersMixin, ProceduralHandlersMixin, ProspectiveHandlersMixin, GraphHandlersMixin):
