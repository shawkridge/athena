...
class ConsolidationMetricsCollector:
    ...
    def __init__(
        ...
        targets: Optional[MetricsTargets] = None
    ):
    ...
    def collect_all_metrics(
        ...
        metrics = ConsolidationMetrics(
            ...
            metric_details={
                ...
                'clustering_stats': self.clustering_calc.get_cluster_stats(clusters) if clusters else {},
...
class MetricsValidator:
    ...
    def validate(self, metrics: ConsolidationMetrics) -> Dict:
        ...
        comp_pass = self.targets.compression_ratio_min <= metrics.compression_ratio <= self.targets.compression_ratio_max
        ...
        # Validate recall
        recall_pass = self.targets.recall_at_5_min <= metrics.recall_at_5 <= self.targets.recall_at_5_max
        ...
        search_pass = self.targets.search_impact_min <= metrics.search_impact_avg <= self.targets.search_impact_max
...
class MetricsAnalyzer:
    ...
    def compare_to_baseline(self, metrics: ConsolidationMetrics) -> Dict:
        ...
        # Compare each metric
        for attr in ['compression_ratio', 'recall_at_5', 'pattern_consistency',
                     'information_density', 'hallucination_rate', 'pattern_diversity_score',
                     'system2_effectiveness_score', 'clustering_cohesion_score',
                     'throughput_patterns_per_sec', 'search_impact_avg']:
    ...
    def get_recommendations(self, metrics: ConsolidationMetrics,
        ...
        return recommendations if recommendations else ["Metrics are healthy. Consider enhancing pattern extraction."]
