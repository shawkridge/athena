...
class MaintainabilityAnalyzer:
    ...
    def analyze_symbol(self, symbol: Symbol) -> MaintainabilityScore:
        ...
        suggestions = self._generate_suggestions(symbol, complexity_score, 
                                                documentation_score, size_score,
                                                duplication_score, style_score)
        ...
        score = MaintainabilityScore(
            ...
            factors={
                "cyclomatic_complexity": symbol.metrics.cyclomatic_complexity if symbol.metrics else 0,
    ...
    def _generate_suggestions(self, symbol: Symbol, 
        ...
        if documentation_score < 50:
            suggestions.append("Add comprehensive documentation with parameter and return descriptions")
